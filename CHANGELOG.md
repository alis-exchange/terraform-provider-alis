...
* **spanner:** compare() detects is_stored changes ([3fb2bdc](https://github.com/alis-exchange/terraform-provider-alis/commit/3fb2bdc9c01f4ec3823552990918d2c2ae5d8659))


### Features

* **spanner:** Add new resources and templates for Google Spanner ([9033c2d](https://github.com/alis-exchange/terraform-provider-alis/commit/9033c2d516f7a51cf9ab4efd519a6fb22a4cef55))
* **spanner:** add timeouts support for Spanner resources ([e4bb782](https://github.com/alis-exchange/terraform-provider-alis/commit/e4bb7820c5a0952623748c7e973371dc427efc20))
* **spanner:** Connection port + credential options builder ([55ef554](https://github.com/alis-exchange/terraform-provider-alis/commit/55ef5546424736dd23a7bb2652178e887f40483f))
* **spanner:** Enhance schema management with new constraints and indexes ([b3514ff](https://github.com/alis-exchange/terraform-provider-alis/commit/b3514ffced7fda40460e4d798b68c7953cdf5b7a))
* **spanner:** Enhance testing and linting setup with new configurations ([949041d](https://github.com/alis-exchange/terraform-provider-alis/commit/949041db0745afc16557665cfe0b947566d1a4c5))
* **spanner:** Introduce `alis_google_spanner_database_sequence` resource ([c66e239](https://github.com/alis-exchange/terraform-provider-alis/commit/c66e239ba4e30ce953d3d7dcd651bb85b5c0980e))
* **spanner:** introduce provider-defined functions for computed-column DDL ([571447c](https://github.com/alis-exchange/terraform-provider-alis/commit/571447c34bbbfa3f80c57041cd5640d9d54473c2))
